...
cars.push(z);
console.log(cars);
//incompleto, stavo provando a fare qualcosa
...
while(numericArray < numericArray[32]);
console.log(numericArray); //incompleto, stavo provando a fare qualcosa
